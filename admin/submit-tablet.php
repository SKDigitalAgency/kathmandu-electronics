...
$_SESSION["selected_page"] = "submit-tablet";
?>
        ...
        <main>
           <div class="container">
               <?php if (isset($_GET["action"]) && $_GET["action"] == "edit"): ?>
                   ...
                   $sql = "SELECT * FROM tablets WHERE file_name = '".$_GET["tablet"]."'";
                   ...
                   ?>
                   <form class="submit_tablet_form" action="submit-tablet.php?page=<?php echo $_SESSION["tablet_model"]; ?>&&action=edit" method="POST" enctype="multipart/form-data">
                       <?php if(isset($_POST["submit"])){submit_tablet("update");} ?>
                       <h1>Edit tablet details for <?php echo $_SESSION["tablet_model"]; ?></h1>
                       <p><input type="submit" name="submit" value="submit"/></p>
                       <div class="form-section">
                           <h2>General</h2>
                           <p>
                               <label class="flt_left" for="field-image">Image</label>
                               <input type="file" name="tablet_image" value=""/>
                               <img src="../images/<?php echo $_SESSION["tablet_image_filename"]; ?>" alt="<?php echo $_SESSION["tablet_model"]; ?>" />
                               <?php echo $_SESSION["tablet_image_filename"]; ?>
                           </p>
                           <p>
                               <label class="flt_left" for="selectfield-brand">Brand</label>
                               <input id="selectfield-brand" type="text" name="brand" value="<?php echo $_SESSION["tablet_brand"]; ?>" />
                           </p>
                           <p>
                               <label class="flt_left" for="textfield-model">Model</label>
                               <input id="textfield-model" type="text" name="model" value="<?php echo $_SESSION["tablet_model"]; ?>"/>
                           </p>

                           <p>
                               <label class="flt_left">Network</label>
                               <input <?php foreach($_SESSION["tablet_network"] as $key => $value){if($value == "LTE"){echo "checked = \"TRUE\" ";}} ?>id="checkboxfield-network-lte" type="checkbox" name="network[]" value="LTE"/>
                               <label id="flt_left" for="checkboxfield-network-lte">LTE</label>
                               <input <?php foreach($_SESSION["tablet_network"] as $key => $value){if($value == "HSDPA"){echo "checked = \"TRUE\" ";}} ?> id="checkboxfield-network-hsdpa" type="checkbox" name="network[]" value="HSDPA"/>
                               <label id="flt_left" for="checkboxfield-network-hsdpa">HSDPA</label>
                               <input <?php foreach($_SESSION["tablet_network"] as $key => $value){if($value == "UMTS"){echo "checked = \"TRUE\" ";}} ?> id="checkboxfield-network-umts" type="checkbox" name="network[]" value="UMTS"/>
                               <label id="flt_left" for="checkboxfield-network-umts">UMTS</label>
                               <input <?php foreach($_SESSION["tablet_network"] as $key => $value){if($value == "GSM"){echo "checked = \"TRUE\" ";}} ?> id="checkboxfield-network-gsm" type="checkbox" name="network[]" value="GSM"/>
                               <label id="flt_left" for="checkboxfield-network-gsm">GSM</label>
                               <input <?php foreach($_SESSION["tablet_network"] as $key => $value){if($value == "CDMA"){echo "checked = \"TRUE\" ";}} ?> id="checkboxfield-network-cdma" type="checkbox" name="network[]" value="CDMA"/>
                               <label id="flt_left" for="checkboxfield-network-cdma">CDMA</label>
                               <input <?php foreach($_SESSION["tablet_network"] as $key => $value){if($value == "HSPA"){echo "checked = \"TRUE\" ";}} ?> id="checkboxfield-network-hspa" type="checkbox" name="network[]" value="HSPA"/>
                           ...
                           <p>
                               ...
                               <input id="textfield-launch" type="date" name="launch_date" value="<?php echo $_SESSION["tablet_launch"]; ?>"/>
                           </p>
                       </div>
                       <div class="form-section">
                           <h2>Body</h2>
                           <p>
                               ...
                               <input id="textfield-height" type="text" name="height" value="<?php echo $_SESSION["tablet_height"]; ?>"/> mm
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-width">Width</label>
                               <input id="textfield-width" type="text" name="width" value="<?php echo $_SESSION["tablet_width"]; ?>"/> mm
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-thickness">Thickness</label>
                               <input id="textfield-thickness" type="text" name="thickness" value="<?php echo $_SESSION["tablet_thickness"]; ?>"/> mm
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-weight">Weight</label>
                               <input id="textfield-weight" type="text" name="weight" value="<?php echo $_SESSION["tablet_weight"]; ?>"/> g
                           </p>
                       </div>
                       ...
                       <div class="form-section">
                           ...
                           <p>
                               ...
                               <select id="selectfield-sim-size" name="sim_size" value="">
                                   <option <?php if($_SESSION["tablet_sim_size"] == "Mini"){echo "selected";} ?>>Mini</option>
                                   <option <?php if($_SESSION["tablet_sim_size"] == "Micro"){echo "selected";} ?>>Micro</option>
                                   <option <?php if($_SESSION["tablet_sim_size"] == "Nano"){echo "selected";} ?>>Nano</option>
                               </select>
                           </p>

                           <p>
                               <label class="flt_left" for="selectfield-sim-count">SIM Count</label>
                               <select id="selectfield-sim-count" name="sim_count" value="<?php echo $_SESSION["tablet_sim_count"]; ?>">
                                   <option <?php if($_SESSION["tablet_sim_count"] == "1"){echo "selected";} ?>>1</option>
                                   <option <?php if($_SESSION["tablet_sim_count"] == "2"){echo "selected";} ?>>2</option>
                                   <option <?php if($_SESSION["tablet_sim_count"] == "3"){echo "selected";} ?>>3</option>
                                   <option <?php if($_SESSION["tablet_sim_count"] == "4"){echo "selected";} ?>>4</option>
                               </select>
                           </p>
                       </div>
                       <div class="form-section">
                           ...
                           <p>
                               ...
                               <input  <?php if($_SESSION["tablet_os"] == "android"){echo "checked";} ?> id="radiofield-os-android" type="radio" name="os" value="android"/>
                               <label for="radiofield-os-android">Android</label>
                               <input <?php if($_SESSION["tablet_os"] == "ios"){echo "checked";} ?> id="radiofield-os-ios" type="radio" name="os" value="ios"/>
                               <label for="radiofield-os-ios">iOS</label>
                               <input <?php if($_SESSION["tablet_os"] == "windows"){echo "checked";} ?> id="radiofield-os-windows" type="radio" name="os" value="windows"/>
                               <label for="radiofield-os-windows">Windows</label>
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-os-version">OS Version</label>
                               <input id="textfield-os-version" type="text" name="os_version" value="<?php echo $_SESSION["tablet_os_version"]; ?>"/>
                           </p>
                       </div>
                       <div class="form-section">
                           <h2>Display</h2>
                           <p>
                               ...
                               <input id="textfield-display-type" type="text" name="display_type" value="<?php echo $_SESSION["tablet_display_type"]; ?>"/>
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-display-size">Size</label>
                               <input id="textfield-display-size" type="text" name="display_size" value="<?php echo $_SESSION["tablet_display_size"]; ?>"/> inches
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-display-screen-to-body-ratio">Screen-to-body Ratio</label>
                               <input id="textfield-display-screen-to-body-ratio" type="text" name="display_screen_to_body_ratio" value="<?php echo $_SESSION["tablet_screen_to_body_ratio"]; ?>"/> %
                           </p>

                           <p>
                               <label class="flt_left">Resolution</label>
                               <input id="textfield-display-resolution_high" type="text" name="display_resolution_high" value="<?php echo $_SESSION["tablet_display_resolution_high"]; ?>"/> x
                               <input id="textfield-display-resolution_low" type="text" name="display_resolution_low" value="<?php echo $_SESSION["tablet_display_resolution_low"]; ?>"/> pixels
                           </p>
                           <p>
                               <label class="flt_left">Touch</label>
                               <input <?php if($_SESSION["tablet_multi_touch_display"] == "1"){echo "checked";} ?> id="radiofield-display-touch-yes" type="radio" name="display_touch" value="1"/>
                               <label for="radiofield-display-touch-yes">Yes</label>
                               <input <?php if($_SESSION["tablet_multi_touch_display"] == "0"){echo "checked";} ?> id="radiofield-display-touch-no" type="radio" name="display_touch" value="0"/>
                               <label for="radiofield-display-touch-no">No</label>
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-display-protection">Protection</label>
                               <input id="textfield-display-protection" type="text" name="display_protection" value="<?php echo $_SESSION["tablet_display_protection"]; ?>"/>
                           </p>
                       </div>
                       <div class="form-section">
                           <h2>CPU</h2>
                           <p>
                               ...
                               <input id="textfield-cpu-chipset" type="text" name="chipset" value="<?php echo $_SESSION["tablet_cpu_chipset"]; ?>"/>
                           </p>

                           <p>
                               <label class="flt_left" for="selectfield-cores-count">Cores Count</label>
                               <select id="selectfield-cores-count" name="cpu_cores_count" value="<?php echo $_SESSION["tablet_cpu_cores_count"]; ?>">
                                   <option <?php if($_SESSION["tablet_cpu_core_count"] == "1"){echo "selected";} ?>>1</option>
                                   <option <?php if($_SESSION["tablet_cpu_core_count"] == "2"){echo "selected";} ?>>2</option>
                                   <option <?php if($_SESSION["tablet_cpu_core_count"] == "3"){echo "selected";} ?>>3</option>
                                   <option <?php if($_SESSION["tablet_cpu_core_count"] == "4"){echo "selected";} ?>>4</option>
                                   <option <?php if($_SESSION["tablet_cpu_core_count"] == "5"){echo "selected";} ?>>6</option>
                                   <option <?php if($_SESSION["tablet_cpu_core_count"] == "6"){echo "selected";} ?>>8</option>
                               </select>
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-cpu-clock-freq">Clock Frequency</label>
                               <input id="textfield-cpu-clock-freq" type="text" name="cpu_clock_freq" value="<?php echo $_SESSION["tablet_cpu_clock_freq"]; ?>"/>
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-cpu-model">CPU Model</label>
                               <input id="textfield-cpu-model" type="text" name="cpu_model" value="<?php echo $_SESSION["tablet_cpu_model"]; ?>"/>
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-gpu">GPU</label>
                               <input id="textfield-gpu" type="text" name="gpu" value="<?php echo $_SESSION["tablet_gpu"]; ?>"/>
                           </p>
                       </div>
                       <div class="form-section">
                           <h2>Memory</h2>
                           <p>
                               ...
                               <input <?php if($_SESSION["tablet_external_memory"] == "1"){echo "checked";} ?> id="radiofield-external-memory-yes" type="radio" name="external_memory" value="1"/>
                               <label for="radiofield-external-memory-yes">Yes</label>
                               <input <?php if($_SESSION["tablet_external_memory"] == "0"){echo "checked";} ?> id="radiofield-external-memory-no" type="radio" name="external_memory" value="0"/>
                           ...
                           <p>
                               ...
                               <input id="textfield-external-memory-size" type="text" name="external_memory_size" value="<?php echo $_SESSION["tablet_external_memory_size"]; ?>"/>
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-internal-memory-size">Internal Memory Size</label>
                               <input id="textfield-internal-memory-size" type="text" name="internal_memory_size" value="<?php echo $_SESSION["tablet_internal_memory_size"]; ?>"/>
                           </p>
                           <script>
                           ...
                           <p>
                               ...
                               <input id="textfield-ram" type="text" name="ram" value="<?php echo $_SESSION["tablet_ram"]; ?>"/>
                           </p>
                       </div>
                       <div class="form-section">
                           <h2>Camera</h2>
                           <p>
                               ...
                               <input id="textfield-primary-camera-size" type="text" name="primary_camera_size" value="<?php echo $_SESSION["tablet_primary_camera_pixel_size"]; ?>"/>
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-primary-camera-description">Primary Camera Description</label>
                               <input id="textfield-primary-camera-description" type="text" name="primary_camera_description" value="<?php echo $_SESSION["tablet_primary_camera_description"]; ?>"/>
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-secondary-camera-size">Secondary Camera Size</label>
                               <input id="textfield-secondary-camera-size" type="text" name="secondary_camera_size" value="<?php echo $_SESSION["tablet_secondary_camera_pixel_size"]; ?>"/>
                           </p>

                           <p>
                               <label class="flt_left" for="textfield-secondary-camera-description">Secondary Camera Description</label>
                               <input id="textfield-secondary-camera-description" type="text" name="secondary_camera_description" value="<?php echo $_SESSION["tablet_secondary_camera_description"]; ?>"/>
                           </p>
                           <p>
                               <label class="flt_left" for="textfield-video">Video</label>
                               <input id="textfield-video" type="text" name="video" value="<?php echo $_SESSION["tablet_video"]; ?>"/>
                           </p>
                       </div>
                       <div class="form-section">
                           <h2>Sound</h2>
                           <p>
                               <?php $arr_len = count($_SESSION["tablet_alert_types"]); ?>
                               <label class="flt_left" for="textfield-alerttypes">Alert Types</label>
                               <span class="input_fields_alert_types_wrap">
                <input type="text" name="alert_types[]" value="<?php echo $_SESSION["tablet_alert_types"]["0"]; ?>">
                <input type="button" id="add_field_alert_types" value="+"/>
                                   <?php for($i = 1;$i < $arr_len;$i ++){ ?>
                                       <span style="display:block;">
                        <input type="text" name="alert_types[]" value="<?php echo $_SESSION["tablet_alert_types"]["$i"]; ?>"/>
                        <input type="button" class="remove_field" value="Remove"/>
                           ...
                           <p>
                               ...
                               <input <?php if($_SESSION["tablet_loudspeaker"] == "1"){echo "checked";} ?> id="radiofield-loudspeaker-yes" type="radio" name="loudspeaker" value="1"/>
                               <label for="radiofield-loudspeaker-yes">Yes</label>
                               <input <?php if($_SESSION["tablet_loudspeaker"] == "0"){echo "checked";} ?> id="radiofield-loudspeaker-no" type="radio" name="loudspeaker" value="0"/>
                               <label for="radiofield-loudspeaker-no">No</label>
                           </p>

                           <p>
                               <label class="flt_left">3.5 mm Jack</label>
                               <input <?php if($_SESSION["tablet_3_5mm_jack"] == "1"){echo "checked";} ?> id="radiofield-3-5mm-jack-yes" type="radio" name="3_5mm_jack" value="1"/>
                               <label for="radiofield-3-5mm-jack-yes">Yes</label>
                               <input <?php if($_SESSION["tablet_3_5mm_jack"] == "0"){echo "checked";} ?> id="radiofield-3-5mm-jack-no" type="radio" name="3_5mm_jack" value="0"/>
                       ...
                       <div class="form-section">
                           ...
                           <p>
                               ...
                               <input id="textfield-wlan" type="text" name="wlan" value="<?php echo $_SESSION["tablet_wlan"]; ?>"/>
                           </p>
                           <p>
                               <label class="flt_left" for="textfield-bluetooth">Bluetooth</label>
                               <input id="textfield-bluetooth" type="text" name="bluetooth" value="<?php echo $_SESSION["tablet_bluetooth"]; ?>"/>
                           </p>
                           <p>
                               <label class="flt_left" for="textfield-gps">GPS</label>
                               <input id="textfield-gps" type="text" name="gps" value="<?php echo $_SESSION["tablet_gps"]; ?>"/>
                           </p>
                           <p>
                               <label class="flt_left" for="textfield-usb">USB</label>
                               <input id="textfield-usb" type="text" name="usb" value="<?php echo $_SESSION["tablet_usb"]; ?>"/>
                           </p>
                           <p>
                               <label class="flt_left">Radio</label>
                               <input <?php if($_SESSION["tablet_radio"] == "1"){echo "checked";} ?> id="radiofield-radio-yes" type="radio" name="radio" value="1"/>
                               <label for="radiofield-radio-yes">Yes</label>
                               <input <?php if($_SESSION["tablet_radio"] == "0"){echo "checked";} ?> id="radiofield-radio-no" type="radio" name="radio" value="0"/>
                       ...
                       <div class="form-section">
                           ...
                           <p>
                               <?php $arr_len = count($_SESSION["tablet_sensors"]); ?>
                               <label class="flt_left" for="textfield-sensors">Sensors</label>
                               <span class="input_fields_sensors_wrap">
                <input type="text" name="sensors[]" value="<?php echo $_SESSION["tablet_sensors"]["0"]; ?>">
                <input type="button" id="add_field_sensors" value="+"/>
                                   <?php for($i = 1;$i < $arr_len;$i ++){ ?>
                                       <span style="display:block;">
                        <input type="text" name="sensors[]" value="<?php echo $_SESSION["tablet_sensors"]["$i"]; ?>"/>
                        <input type="button" class="remove_field" value="Remove"/>
                    </span>
                                   <?php } ?>
            </span>
                           ...
                           <p>
                               <?php $arr_len = count($_SESSION["tablet_messaging"]); ?>
                               <label class="flt_left" for="textfield-messaging">Messaging</label>
                               <span class="input_fields_messaging_wrap">
                <input type="text" name="messaging[]" value="<?php echo $_SESSION["tablet_messaging"]["0"]; ?>">
                <input type="button" id="add_field_messaging" value="+"/>
                                   <?php for($i = 1;$i < $arr_len;$i ++){ ?>
                                       <span style="display:block;">
                        <input type="text" name="messaging[]" value="<?php echo $_SESSION["tablet_messaging"]["$i"]; ?>"/>
                        <input type="button" class="remove_field" value="Remove"/>
                    </span>
                                   <?php } ?>
            </span>
                           ...
                           <p>
                               ...
                               <input id="textfield-browser" type="text" name="browser" value="<?php echo $_SESSION["tablet_browser"]; ?>"/>
                           </p>
                           <p>
                               <label class="flt_left">Java</label>
                               <input <?php if($_SESSION["tablet_java"] == "1"){echo "checked";} ?> id="radiofield-java-yes" type="radio" name="java" value="1"/>
                               <label for="radiofield-java-yes">Yes</label>
                               <input <?php if($_SESSION["tablet_java"] == "0"){echo "checked";} ?> id="radiofield-java-no" type="radio" name="java" value="0"/>
                               <label for="radiofield-java-no">No</label>
                           </p>
                           <p>
                               <?php $arr_len = count($_SESSION["tablet_other_features"]); ?>
                               <label class="flt_left" for="textfield-other-features">Other Features</label>
                               <span class="input_fields_other_features_wrap">
                <input type="text" name="other_features[]" value="<?php echo $_SESSION["tablet_other_features"]["0"]; ?>">
                <input type="button" id="add_field_other_features" value="+"/>
                                   <?php for($i = 1;$i < $arr_len;$i ++){ ?>
                                       <span style="display:block;">
                        <input type="text" name="other_features[]" value="<?php echo $_SESSION["tablet_other_features"]["$i"]; ?>"/>
                        <input type="button" class="remove_field" value="Remove"/>
                    </span>
                                   <?php } ?>
            </span>
                           ...
                           <p>
                               <?php $arr_len = count($_SESSION["tablet_colors"]); ?>
                               <label class="flt_left" for="textfield-colors">Colors</label>
                               <span class="input_fields_colors_wrap">
                <input type="text" name="colors[]" value="<?php echo $_SESSION["tablet_colors"]["0"]; ?>">
                <input type="button" id="add_field_colors" value="+"/>
                                   <?php for($i = 1;$i < $arr_len;$i ++){ ?>
                                       <span style="display:block;">
                        <input type="text" name="colors[]" value="<?php echo $_SESSION["tablet_colors"]["$i"]; ?>"/>
                        <input type="button" class="remove_field" value="Remove"/>
                    </span>
                                   <?php } ?>
            </span>
                       ...
                       <div class="form-section">
                           ...
                           <p>
                               ...
                               <input id="textfield-battery-size" type="text" name="battery_size" value="<?php echo $_SESSION["tablet_battery_size"]; ?>"/>
                           </p>
                           <p>
                               <label class="flt_left">Removable</label>
                               <input <?php if($_SESSION["tablet_battery_removable"] == "1"){echo "checked";} ?> id="radiofield-battery-removable-yes" type="radio" name="battery_removable" value="1"/>
                               <label for="radiofield-battery-removable-yes">Yes</label>
                               <input <?php if($_SESSION["tablet_battery_removable"] == "0"){echo "checked";} ?> id="radiofield-battery-removable-no" type="radio" name="battery_removable" value="0"/>
                           ...
                           <p>
                               ...
                               <select id="selectfield-battery-type" name="battery_type" value="">
                                   <option <?php if($_SESSION["tablet_battery_type"] == "Li-Ion"){echo "selected";} ?>>Li-Ion</option>
                                   <option <?php if($_SESSION["tablet_battery_type"] == "Li-Polymer"){echo "selected";} ?>>Li-Polymer</option>
                               </select>
                           </p>
                       </div>
                       <?php

                       $sql = "SELECT tablet_id FROM `tablets` WHERE file_name = '".$_GET["tablet"]."'";
                       $result = mysqli_query($conn,$sql);
                       while($row = mysqli_fetch_assoc($result)){
                           foreach($row as $key => $value){
                               $tablet_id = $value;
               ...
               <?php else: ?>
                   <form class="submit_tablet_form" action="submit-tablet.php" method="POST" enctype="multipart/form-data">
                       <?php if(isset($_POST["submit"])){submit_tablet("insert");} ?>
                       <h1>Enter tablet details</h1>
                       <p><input type="submit" name="submit" value="submit"/></p>
                       <div class="form-section">
                           <h2>General</h2>
                           <p>
                       ...
                       <div class="form-section">
                           ...
                           <p>
                               <label class="flt_left" for="selectfield-cores-count">Cores Count</label>
                               <select id="selectfield-cores-count" name="cpu_cores_count" value="">
                                   <option>1</option>
                                   <option>2</option>
                                   <option>3</option>
                                   <option>4</option>
            ...
            $(".add_availability").click(function(){
                ...
                xhr.onreadystatechange = function(){
                    if((xhr.readyState == 4) && (xhr.status == 200 || xhr.status == 304)){
                        ...
                        $(".submit_tablet_form").append($new_form_section);
                        count++;
